...
//        tblProveedor.setIdproveedorcl2(1); // ID del proveedor a actualizar
//        tblProveedor.setNomproveedorcl2("Distribuidor Arequipa");
//        tblProveedor.setRucproveedorcl2("20678901234");
//        tblProveedor.setRsocialproveedorcl2("Distribuidor Arequipa SAC");
//        tblProveedor.setEmailproveedorcl2("contacto@arequipa.com");
//        tblProveedor.setFeingproveedorcl2(new Date());
//        crudImp.ActualizarProveedor(tblProveedor);
        ...
        /*
        tblProveedor.setIdproveedorcl2(1); // ID del proveedor a buscar
...
//        List<TblProveedorcl2> listadoProveedores = crudImp.ListadoProveedores();
